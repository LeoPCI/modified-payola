...
module Payola
  class Subscription < ActiveRecord::Base
    ...
    belongs_to :plan, polymorphic: true, optional: (Rails::VERSION::MAJOR > 4)
    belongs_to :owner, polymorphic: true, optional: (Rails::VERSION::MAJOR > 4)
    belongs_to :affiliate, optional: (Rails::VERSION::MAJOR > 4)    
